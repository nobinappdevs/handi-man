...
export function HowItWorks() {
  ...
  return (
    <section className="brand-wash relative border-t border-border [--wash-angle:152deg] [--wash-strength:13%] px-[clamp(18px,3vw,44px)] pt-[clamp(40px,4.6vw,74px)] pb-[clamp(48px,5.6vw,88px)]">
      <div className="mx-auto flex max-w-[1240px] flex-col gap-[clamp(28px,3.2vw,46px)]">
        <div className="flex flex-wrap items-end justify-between gap-x-10 gap-y-5">
          ...
          <p className="min-w-0 max-w-[40ch] text-[14.5px] leading-[1.65] font-medium text-body text-pretty">
        ...
        <div className="grid grid-cols-1 items-stretch gap-[clamp(18px,2vw,28px)] wide:grid-cols-[minmax(0,1.02fr)_minmax(0,1fr)]">
          {/* Active-step panel */}
          <div className="relative flex min-h-[clamp(300px,30vw,392px)] min-w-0 flex-col justify-between gap-[clamp(24px,3vw,40px)] overflow-hidden bg-ink p-[clamp(26px,3vw,44px)] text-white">
            <span
              aria-hidden
